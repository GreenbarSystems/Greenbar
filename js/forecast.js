...
const gbForecast = (() => {
  ...
  function sectionHTML(){
    ...
    const upcomingHtml = f.upcoming.length
      ? f.upcoming.slice(0, 6).map(u => `<div style="display:flex;justify-content:space-between;align-items:center;padding:6px 0;border-bottom:1px solid rgba(255,255,255,0.05);font-size:12.5px;">
